...
// Blocks of Arduino Category
Blockly.Blocks.arduino_setup_loop={init:function(){this.jsonInit({message0:Blockly.Msg.ARDUINO_SETUP,message1:'%1',message2:Blockly.Msg.ARDUINO_LOOP,message3:"%1",args0:[],args1:[{type:"input_statement",name:"setup"}],args2:[],args3:[{type:"input_statement",name:"loop"}],colour:Blockly.Colours.arduino.primary})}};
Blockly.Blocks.arduino_serial_readline={init:function(){this.jsonInit({message0:Blockly.Msg.ARDUINO_SERIAL_READLINE,message1:'%1',args0:[],args1:[{type:"input_statement",name:"v1"}],colour:Blockly.Colours.arduino.primary,extensions:["shape_statement"]})}};
Blockly.Blocks.arduino_serial_begin={init:function(){this.jsonInit({message0:Blockly.Msg.ARDUINO_SERIAL_BEGIN,args0:[{type:"input_value",name:"baudrate"}],colour:Blockly.Colours.arduino.primary,extensions:["shape_statement"]})}};
Blockly.Blocks.arduino_pin_mode={init:function(){this.jsonInit({message0:Blockly.Msg.ARDUINO_PIN_MODE,message1:'%1',args0:[{type:"input_value",name:"pin_number"}],args1:[{type:'input_value',name:'in_out_put'}],colour:Blockly.Colours.arduino.primary,extensions:["shape_statement"]})}};
Blockly.Blocks.arduino_all_pins={init:function(){this.jsonInit({message0:'%1',args0:[{type:'field_dropdown',name:'all_pin',options:[['0','d0'],['1','d1'],['2','d2'],['3','d3'],['4','d4'],['5','d5'],['6','d6'],['7','d7'],['8','d8'],['9','d9'],['10','d10'],['11','d11'],['12','d12'],['13','d13'],['A0','A0'],['A1','A1'],['A2','A2'],['A3','A3'],['A4','A4'],['A5','A5']]}],colour:Blockly.Colours.arduino.primary,extensions:["output_string"]})}};
Blockly.Blocks.arduino_input_output={init:function(){this.jsonInit({message0:'%1',args0:[{type:'field_dropdown',name:'in_out',options:[['INPUT','input'],['OUTPUT','output'],['INPUT_PULLUP','input_pullup']]}],colour:Blockly.Colours.arduino.primary,extensions:["output_string"]})}};
Blockly.Blocks.arduino_digital_write={init:function(){this.jsonInit({message0:Blockly.Msg.ARDUINO_DIGITAL_WRITE,message1:'%1',args0:[{type:'input_value',name:'pin_number'}],args1:[{type:'input_value',name:'high_low_specs'}],colour:Blockly.Colours.arduino.primary,extensions:["shape_statement"]})}};
Blockly.Blocks.arduino_high_low={init:function(){this.jsonInit({message0:'%1',args0:[{type:'field_dropdown',name:'high_low',options:[['HIGH','high'],['LOW','low']]}],colour:Blockly.Colours.arduino.primary,extensions:['output_string']})}};
Blockly.Blocks.arduino_analog_write={init:function(){this.jsonInit({message0:Blockly.Msg.ARDUINO_ANALOG_WRITE,message1:'%1',args0:[{type:'input_value',name:'pwm_pins'}],args1:[{type:'input_value',name:'pwm'}],colour:Blockly.Colours.arduino.primary,extensions:['shape_statement']})}};
Blockly.Blocks.arduino_pwm_pin={init:function(){this.jsonInit({message0:'%1',args0:[{type:'field_dropdown',name:'digital_pin',options:[['3','d3'],['5','d5'],['6','d6'],['9','d9'],['10','d10'],['11','d11']]}],colour:Blockly.Colours.arduino.primary,extensions:['output_string']})}};
Blockly.Blocks.arduino_digital_read={init:function(){this.jsonInit({message0:Blockly.Msg.ARDUINO_DIGITAL_READ,args0:[{type:'input_value',name:'pins'}],colour:Blockly.Colours.arduino.primary,extensions:['output_boolean']})}};
Blockly.Blocks.arduino_analog_read={init:function(){this.jsonInit({message0:Blockly.Msg.ARDUINO_ANALOG_READ,args0:[{type:'input_value',name:'analog_pin'}],colour:Blockly.Colours.arduino.primary,extensions:['output_number']})}};
Blockly.Blocks.arduino_analog_pin={init:function(){this.jsonInit({message0:'%1',args0:[{type:'field_dropdown',name:'analog_pin',options:[['A0','A0'],['A1','A1'],['A2','A2'],['A3','A3'],['A4','A4'],['A5','A5']]}],colour:Blockly.Colours.arduino.primary,extensions:['output_string']})}};
Blockly.Blocks.arduino_led={init:function(){this.jsonInit({message0:Blockly.Msg.ARDUINO_LED,message1:'%1',args0:[{type:'input_value',name:'pins'}],args1:[{type:'input_value',name:'on_off'}],colour:Blockly.Colours.arduino.primary,extensions:['shape_statement']})}};
Blockly.Blocks.arduino_on_off={init:function(){this.jsonInit({message0:'%1',args0:[{type:'field_dropdown',name:'on_off',options:[['ON','on'],['OFF','off']]}],colour:Blockly.Colours.arduino.primary,extensions:['output_string']})}};
Blockly.Blocks.arduino_serial_print={init:function(){this.jsonInit({message0:Blockly.Msg.ARDUINO_SERIAL_PRINT,args0:[{type:'input_value',name:'text'}],colour:Blockly.Colours.arduino.primary,extensions:['shape_statement']})}};

// Blocks of Sensor Category
Blockly.Blocks.sensor_analog_sensor={init:function(){this.jsonInit({})}};
