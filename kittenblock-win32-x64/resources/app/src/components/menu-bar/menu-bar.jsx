            ...
            <Box className={styles.menuBar}>
                <div className={styles.mainMenu}>
                    <div className={styles.fileGroup}>
                        ...
                        <div
                            className={classNames(styles.menuBarItem, styles.hoverable, {
                                [styles.active]: this.props.hardwareMenuOpen
                            })}
                            onMouseUp={this.props.onClickHardware}
                        >
                            <div className={classNames(styles.hardwareMenu)}>
                                <FormattedMessage
                                    defaultMessage="Hardware"
                                    description="Hardware dropdown menu"
                                    id="gui.menuBar.hardware"
                                />
                            </div>
                            <MenuBarMenu
                                open={this.props.hardwareMenuOpen}
                                onRequestClose={this.props.onRequestCloseHardware}
                            >
                                <MenuItem
                                    onClick={() => {
                                        this.props.clickArduinoMenu()
                                    }}
                                >
                                    <FormattedMessage
                                        defaultMessage="Arduino"
                                        description="Menu bar item for Arduino blocks"
                                        id="gui.menuBar.arduino"
                                    />
                                </MenuItem>
                            </MenuBarMenu>
                        </div>
                        ...
                        >
                            <div className={classNames(styles.editMenu)}>
                                <FormattedMessage
                                    ...
                                    description="Upload dropdown menu"
...
MenuBar.propTypes = {
    ...
    onClickHardware: PropTypes.func,
...
const mapStateToProps = state => ({
    ...
    uploadMenuOpen: uploadMenuOpen(state)
});
...
const mapDispatchToProps = dispatch => ({
    ...
    onClickHardware: () => dispatch(openHardwareMenu()),
    onRequestCloseHardware: () => dispatch(closeHardwareMenu()),
    onClickLanguage: () => dispatch(openLanguageMenu()),
    onRequestCloseLanguage: () => dispatch(closeLanguageMenu()),
    onSeeCommunity: () => dispatch(setPlayer(true)),
    clickArduinoMenu: () => dispatch(clickArduinoMenu()),
    clickUploadMenu: () => dispatch(clickUploadMenu())
});
