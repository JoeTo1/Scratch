...
const arduino = function (isStage) {
    return `
    <category
        name="Arduino"
        id="arduino"
        colour="#00979C"
        secondaryColour="#00979f">
        <block type="arduino_setup_loop"/>
        <block type="arduino_serial_readline"></block>
        ...
        <block type="arduino_pin_mode">
            <value name="pin_number">
                <shadow type="arduino_all_pins">
                </shadow>                
            </value>
            <value name="in_out_put">
                <shadow type="arduino_input_output">
                </shadow>                
            </value>
        </block>
        <block type="arduino_digital_write">
            ...
            <value name="high_low_specs">
                <shadow type="arduino_high_low">
                </shadow>
            </value>
        </block>
        <block type="arduino_analog_write">
            <value name="pwm_pins">
                <shadow type="arduino_pwm_pin">
                </shadow>
            </value>
            <value name="pwm">
                <shadow type="math_positive_number">
        ...
        <block type="arduino_analog_read">
            <value name="analog_pin">
                <shadow type="arduino_analog_pin">
                </shadow>
            </value>
        </block>
        <block type="arduino_led">
            <value name="pins">
                <shadow type="arduino_all_pins">
                </shadow>
            </value>
            <value name="on_off">
                <shadow type="arduino_on_off">
                </shadow>
            </value>
        </block>
 ...
 */
const makeToolboxXML = function (isStage, targetId, categoriesXML, arduinoMenuClicked = false) {
    ...
    if (arduinoMenuClicked) {
        everything.push(gap, arduino(isStage, targetId));
    }
